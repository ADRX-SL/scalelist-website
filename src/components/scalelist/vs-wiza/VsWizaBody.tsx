...
import { WIZA_REVIEW } from "@/components/scalelist/vs-wiza/constants";

const VsWizaBody: React.FC = () => {
  const content = WIZA_REVIEW;
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} native button in Sales Navigator.</p>
            </div>
          </div>
      ...
      {/* Real-Time Verification Benchmark */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Real-Time Verification Benchmark</h2>
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "The 'pay-for-performance' model is a significant advantage. It ensures that teams only pay for valid, deliverable emails, which justifies the tool's cost immediately."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Email Find Rate</div>
                  <div className="text-2xl font-bold text-[#121212]">{content.accuracyData.email}</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Verification Model</div>
                  <div className="text-2xl font-bold text-[#121212]">Real-Time SMTP Checks</div>
                </div>
              </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Why specialized hygiene often beats static database extraction for growth teams.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Automated extraction from Sales Navigator</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Bulk enrichment and AI-based hygiene</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Data Cleaning</td>
                  <td className="py-6 px-8 text-gray-500">SMTP Verification</td>
                ...
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">None (One-time extraction)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Automated weekly job-change alerts</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Multi-Provider</td>
                  <td className="py-6 px-8 text-gray-500">Proprietary logic</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">10+ Verified Data Sources</td>
                </tr>
              </tbody>
            </table>
          </div>
