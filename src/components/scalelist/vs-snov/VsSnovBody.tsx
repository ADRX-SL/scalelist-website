...
import { SNOV_REVIEW } from "@/components/scalelist/vs-snov/constants";

const VsSnovBody: React.FC = () => {
  const content = SNOV_REVIEW;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} all-in-one sales interface.</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Authoritative Verdict</h2>
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "In 2025, Snov.io stands as a top-tier choice for scaling outbound efforts. It's a well-rounded tool that empowers sales teams to work smarter."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  ...
                  <div className="text-2xl font-bold text-[#121212]">Robust 7-Tier Process</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Account Warm-up</div>
                  <div className="text-2xl font-bold text-[#121212]">Unlimited in Pro Plan</div>
                </div>
              </div>
              <div className="bg-[#121212] text-white p-8 rounded-2xl border border-gray-800 shadow-2xl">
                <div className="text-sm font-bold text-[#3477E4] uppercase mb-2">Snov.io 2025 Tiers</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">The difference between an outreach suite and a hygiene-first engine.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">All-in-one outreach & CRM</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Data Enrichment & Hygiene</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Mobile Numbers</td>
                  <td className="py-6 px-8 text-gray-500">Secondary feature</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Verified Global Coverage</td>
                </tr>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 font-bold text-[#3477E4]">AI-Powered Format & Verify</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">Manual search required</td>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-[#121212] rounded-[3rem] py-24 px-8 relative overflow-hidden shadow-2xl border border-gray-800">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto relative z-10">
              Don't settle for static exports. Scalelist provides verified emails, mobile numbers, and real-time monitoring to keep your sales pipeline fresh and active.
            </p>
