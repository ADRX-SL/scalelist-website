...
import { FULLENRICH_REVIEW } from "@/components/scalelist/vs-fullenrich/constants";

const VsFullenrichBody: React.FC = () => {
  const content = FULLENRICH_REVIEW;
  ...
  return (
    <>
      ...
      {/* What is Fullenrich + Screenshot 1 */}
            ...
            <div className="w-full md:w-1/2">
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-2">
                <img 
                  ...
                  alt={`${content.competitorName} Chrome Extension`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} Chrome extension and bulk processing UI.</p>
            </div>
          </div>
      ...
      {/* Accuracy & Waterfall Benchmark */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Enrichment Benchmark</h2>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-3 overflow-hidden">
                <img 
                  src={content.reviewScreenshot} 
                  alt={`${content.competitorName} Waterfall Results`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "The waterfall enrichment process is remarkably effective. Sequentially querying 20+ sources ensures a much higher find rate than static databases, specifically for those elusive executive-level prospects."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  ...
                  <div className="text-2xl font-bold text-[#121212]">Triple-Verified Logic</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Team Scalability</div>
                  <div className="text-2xl font-bold text-[#121212]">Unlimited Seat Policy</div>
                </div>
              </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Data enrichment & appends</td>
                ...
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Waterfall (Sequential Search)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">10+ Verified Global Data Sources</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">None (One-time enrichment)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Automated weekly job-change alerts</td>
                </tr>
                <tr className="border-b border-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Cleaning Depth</td>
...
export default VsFullenrichBody;
