...
import { ZOOMINFO_REVIEW } from "@/components/scalelist/vs-zoominfo/constants";

const VsZoominfoBody: React.FC = () => {
  const content = ZOOMINFO_REVIEW;
  ...
  return (
    <>
      ...
      {/* Feature Analysis + Screenshot 1 (Landing) */}
            ...
            <div className="w-full md:w-1/2">
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-2 flex items-center justify-center min-h-[300px]">
                ...
                <img 
                  ...
                  alt="ZoomInfo Website Interface" 
                  className="w-full h-auto rounded-lg object-cover"
                />
              </div>
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} go-to-market interface.</p>
            </div>
          </div>
      ...
      {/* Accuracy & User Feedback + Screenshot 2 (Review) */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Reality Check: User Feedback</h2>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-3 overflow-hidden">
                <img 
                  src={content.reviewScreenshot} 
                  alt="ZoomInfo G2 Review" 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "Great integration but costly for small businesses... user feedback suggests data quality can be inconsistent."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="bg-[#121212] text-white p-8 rounded-2xl border border-gray-800 shadow-2xl">
                <div className="text-sm font-bold text-[#3477E4] uppercase mb-2">The Cost Reality</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Why top sales teams are switching to agile data tools.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Contract Type</td>
                  <td className="py-6 px-8 text-gray-500">Annual/Multi-year Lock-in</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Flexible Monthly Plans</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Mobile Coverage</td>
                  <td className="py-6 px-8 text-gray-500">Static (US Focused)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Verified Global Mobiles</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Email Verification</td>
                  <td className="py-6 px-8 text-gray-500">Periodic Updates</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Real-Time Strict Verification</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Primary Value</td>
                  <td className="py-6 px-8 text-gray-500">Full GTM Operating System</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Verified Email & Mobile Finder</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-[#121212] rounded-[3rem] py-24 px-8 relative overflow-hidden shadow-2xl border border-gray-800">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto relative z-10">
              Stop guessing and start connecting. Scalelist provides high-accuracy, verified emails and direct mobile numbers for your target prospects.
            </p>
