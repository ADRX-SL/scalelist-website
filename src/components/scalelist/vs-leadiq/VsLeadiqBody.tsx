...
import { LEADIQ_REVIEW } from "@/components/scalelist/vs-leadiq/constants";

const VsLeadiqBody: React.FC = () => {
  const content = LEADIQ_REVIEW;
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} extension and capture interface.</p>
            </div>
          </div>
      ...
      {/* Review Screenshot + Scribe Highlight */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Workflow Efficiency Verdict</h2>
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "If your team focuses on LinkedIn, {content.competitorName} is a natural fit. Scribe adds a unique layer of value by automating discovery call hygiene."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  ...
                  <div className="text-2xl font-bold text-[#121212]">Real-Time SMTP Status</div>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Duplicate Handling</div>
                  <div className="text-2xl font-bold text-[#121212]">Zero Credits for CRM Records</div>
                </div>
              </div>
              <div className="bg-[#121212] text-white p-8 rounded-2xl border border-gray-800 shadow-2xl">
                <div className="text-sm font-bold text-[#3477E4] uppercase mb-2">{content.competitorName} 2025 Tiers</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Why specialized enrichment engines often outperform capture tools for large lists.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Manual capture from LinkedIn</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Bulk enrichment of custom lists</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Data Cleaning</td>
                  <td className="py-6 px-8 text-gray-500">Basic verification</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">AI-Powered Format & Emojis Removal</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Sourcing Model</td>
                  <td className="py-6 px-8 text-gray-500">Proprietary Database</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Multi-Provider (10+ sources)</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Lead Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">None (Static)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Automated Job-Change Alerts</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-[#121212] rounded-[3rem] py-24 px-8 relative overflow-hidden shadow-2xl border border-gray-800">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto relative z-10">
              Don't settle for static exports or manual capture tools. Experience the power of verified, monitored prospect lists that update automatically.
            </p>
