import chrisHackettImg from "@/assets/email-verifier/chris-hackett.webp";
import baptisteGraffinImg from "@/assets/email-verifier/baptiste-graffin.webp";
import iconApollo from "@/assets/email-verifier/icon-apollo.png";
import iconZoomInfo from "@/assets/email-verifier/icon-zoominfo.png";
import iconLusha from "@/assets/email-verifier/icon-lusha.png";
import iconProspeo from "@/assets/email-verifier/icon-prospeo.png";
import iconFullenrich from "@/assets/email-verifier/icon-fullenrich.png";
import iconScalelist from "@/assets/email-verifier/icon-scalelist.png";
