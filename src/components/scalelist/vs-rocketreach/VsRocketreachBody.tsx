...
import { ROCKETREACH_REVIEW } from "@/components/scalelist/vs-rocketreach/constants";

const VsRocketreachBody: React.FC = () => {
  const content = ROCKETREACH_REVIEW;
  ...
  return (
    <>
      ...
      {/* What is RocketReach + Screenshot 1 */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} contact discovery interface.</p>
            </div>
          </div>
      ...
      {/* Accuracy & Review Screenshot */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Data Accuracy Verdict</h2>
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "If your primary goal is accurate B2B emails at scale, RocketReach is one of the top tools. It transforms passive browsing into active prospecting."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="bg-[#121212] text-white p-8 rounded-2xl border border-gray-800 shadow-2xl">
                <div className="text-sm font-bold text-[#3477E4] uppercase mb-2">RocketReach 2025 Tiers</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Why specialized data hygiene tools often outperform all-in-one databases.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  ...
                  <td className="py-6 px-8 text-gray-500">Contact lookups & list building</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">List enrichment & Data Cleaning</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Mobile Numbers</td>
                  <td className="py-6 px-8 text-gray-500">Available (Variable Accuracy)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Verified Global Mobiles</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Data Management</td>
                  <td className="py-6 px-8 text-gray-500">Basic export to CSV</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Advanced AI-Powered Cleaning</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-6 px-8 font-semibold text-gray-700">Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">Static Export</td>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-[#121212] rounded-[3rem] py-24 px-8 relative overflow-hidden shadow-2xl border border-gray-800">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto relative z-10">
              Don't settle for static data that expires the moment you export it. Experience the power of verified, monitored prospect lists and close more deals.
            </p>
...
export default VsRocketreachBody;
