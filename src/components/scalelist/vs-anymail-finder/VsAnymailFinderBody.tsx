...
import { ANYMAIL_FINDER_REVIEW } from "@/components/scalelist/vs-anymail-finder/constants";

const VsAnymailFinderBody: React.FC = () => {
...
export default VsAnymailFinderBody;
