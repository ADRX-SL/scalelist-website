...
import { SEAMLESS_REVIEW } from "@/components/scalelist/vs-seamless/constants";

const VsSeamlessBody: React.FC = () => {
  const content = SEAMLESS_REVIEW;
  ...
  return (
    <>
            ...
            <div className="w-full md:w-1/2">
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-2">
                <img 
                  ...
                  alt={`${content.competitorName} AI Search Interface`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <p className="mt-4 text-center text-sm text-gray-400 italic">Exploring the {content.competitorName} real-time validation dashboard.</p>
            </div>
          </div>
      ...
      {/* Review Screenshot + AI Focus */}
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl font-extrabold tracking-tight mb-8">Real-Time Search Verdict</h2>
              <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-3 overflow-hidden">
                <img 
                  src={content.reviewScreenshot} 
                  alt={`${content.competitorName} Social Assistant`} 
                  className="w-full h-auto rounded-lg"
                />
              </div>
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-[#3477E4] font-medium italic">
                  "The AI-powered 10-step verification engine gives it a distinct advantage over static databases. It justifies the investment by filling the pipeline with verified leads."
                </p>
              </div>
            </div>
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 group hover:border-[#3477E4] transition-colors">
                  <div className="text-gray-500 text-xs font-bold uppercase mb-1">Direct Dialing</div>
                  <div className="text-2xl font-bold text-[#121212]">Mobile & AI-Sourced Dials</div>
                </div>
              </div>
              <div className="bg-[#121212] text-white p-8 rounded-2xl border border-gray-800 shadow-2xl">
                <div className="text-sm font-bold text-[#3477E4] uppercase mb-2">{content.competitorName} 2025 Model</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Why specialized hygiene often beats real-time search for curated list quality.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Core Engine</td>
                  <td className="py-6 px-8 text-gray-500">Real-time AI web search</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Multi-Provider (10+) enrichment</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Data Cleaning</td>
                  <td className="py-6 px-8 text-gray-500">Moderate (Search results)</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">AI-Powered (Clean names, remove emojis)</td>
                </tr>
                <tr className="border-b border-gray-50">
                  <td className="py-6 px-8 font-semibold text-gray-700">Monitoring</td>
                  <td className="py-6 px-8 text-gray-500">Job Changes Tracker</td>
                ...
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-6 px-8 text-gray-500">High-volume LinkedIn search</td>
                  <td className="py-6 px-8 font-bold text-[#3477E4]">Curated, clean, monitored databases</td>
                </tr>
              </tbody>
            </table>
          </div>
