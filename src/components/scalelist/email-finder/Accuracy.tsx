import chrisHackettImg from "@/assets/email-finder/chris-hackett.webp";
import baptisteGraffinImg from "@/assets/email-finder/baptiste-graffin.webp";
import iconApollo from "@/assets/email-finder/icon-apollo.png";
import iconZoomInfo from "@/assets/email-finder/icon-zoominfo.png";
import iconLusha from "@/assets/email-finder/icon-lusha.png";
import iconProspeo from "@/assets/email-finder/icon-prospeo.png";
import iconFullenrich from "@/assets/email-finder/icon-fullenrich.png";
import iconScalelist from "@/assets/email-finder/icon-scalelist.png";
