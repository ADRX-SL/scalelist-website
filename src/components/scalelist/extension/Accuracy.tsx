import chrisHackettImg from "@/assets/extension/chris-hackett.webp";
import baptisteGraffinImg from "@/assets/extension/baptiste-graffin.webp";
import iconApollo from "@/assets/extension/icon-apollo.png";
import iconZoomInfo from "@/assets/extension/icon-zoominfo.png";
import iconLusha from "@/assets/extension/icon-lusha.png";
import iconProspeo from "@/assets/extension/icon-prospeo.png";
import iconFullenrich from "@/assets/extension/icon-fullenrich.png";
import iconScalelist from "@/assets/extension/icon-scalelist.png";
